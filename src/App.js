...
function App() {
  ...
  return (
    <div style={{height:'100vh'}} className='d-flex justify-content-center align-item-center w-100 bg-dark'>
      <div className='bg-light p-5 rounded'style={{width:'500px'}}>
        ...
        <form className='mt-5'onSubmit={handleCalculate}>
          ...
          <div className='mb-3'>
          <TextField name='rate' value={rate || ""} className='w-100' id="outlined-basic" label="Rate of interest(r.a) %" variant="outlined" onChange={(e)=>getvalidate(e)}/>
          </div>
          { !isRate &&
          <div>
            <p className='text-danger fw-bolder'>Invalid Input</p>
